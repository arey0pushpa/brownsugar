//YUP GOING to  creating an express
...
var express 	= require('express'),
    ...
    // hash object to save clients data yea old hash ,
    // { socketid: { clientid, nickname }, socketid: { ... } }
    chatClients = new Object();

// listening to port... LAST WAY ::
server.listen(port);
...
// serving of the main application on thee index.html
...
// disconnections (why not ?? hahah ...)

io.set('log level', 2);

//'xhr-polling'in case of not supported (like Comet/Long polling).
